...
public class OnapLoggerAuditTest {
    ...
    private final String TEST_CLASS_NAME = this.getClass().getName();
    ...
    public void validateAuditLog(LogLevel logLevel, LoggingEvent log) {
        ...
        assertNotNull(mdc.get("BeginTimestamp"));
    }
